...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(17,0){\includegraphics[scale=0.8]{One Last Bebbo Sunset.png}}} % Image background
...
\vspace*{\fill}
\begin{center}
{\scshape\huge 28 Views of Mount Bebbo\par}
\vspace{1cm}
{\Large by Patrick\par}
\end{center}
\vspace*{\fill}
\newpage
...
\noindent LaTeX Template by: Ciro García \\
